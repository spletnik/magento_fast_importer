...
<select name="XML:filename" id="xmlfile">
	<?php foreach($files as $fname){ ?>
		<option <?php if($fname==$this->getParam("XML:filename")){?>selected=selected<?php }?> value="<?php echo $fname?>"><?php echo basename($fname)?></option>
	<?php }?>
</select>
<a id='xmldl' href="./download_file.php?file=<?php $this->getParam("XML:filename")?>">Download XML</a>
