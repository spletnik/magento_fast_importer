...
class Spletnisistemi_Fastimporter_Block_Adminhtml_Fastimporter_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
    protected function _prepareForm() {
        ...
        $fieldset->addField('newfilename', 'file', array(
            'label'    => Mage::helper('fastimporter')->__('File'),
            'required' => false,
            'name'     => 'filename',
        ));
        $profile_data = Mage::registry('fastimporter_data')->getData();
        $fieldset->addField('filename', 'label', array(
            'label'    => Mage::helper('fastimporter')->__('Uploaded File'),
            'required' => false,
            'name'     => 'filename',
            "note"     => '<a href="' . Mage::getBaseUrl("media") . "import/" . $profile_data["filename"] . '">Download</a>',
        ));
        ...
        /*$fieldset->addField('filename', 'link', array(
            ...
            'required'  => false,
            'name'      => 'filename',
            'href'      =>  Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_WEB).'var/import/'.Mage::registry('fastimporter_data')->getData()['filename'],
  p      ));*/
        ...
        $fieldset->addField('old', 'select', array(
